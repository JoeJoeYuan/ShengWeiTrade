...
namespace IService
{
    public interface IMessagesService
    {
        ...
        /// <param name="message">查询条件，若无此条件请保持该属性默认值</typeparam>
        /// <returns></returns>
        List<Messages> GetByPage(int startIndex, int count, string sortColumn, Messages message);
        /// <summary>
        /// 获取记录条数
        /// </summary>
        /// <param name="message">查询条件，若无此条件请保持该属性默认值</typeparam>
        /// <returns></returns>
        int GetCount(Messages message);
        /// <summary>
        /// 更新数据
        /// </summary>
        /// <param name="message">需要更新的数据实体</param>
        /// <returns></returns>
        ...
        /// 插入数据
        /// </summary>
        /// <param name="message">需要插入的数据实体</param>
        /// <returns></returns>
